...
<Header />
<!-- Desktop -->
<div class="hidden screen-height items-center justify-center sm:flex">
...
<div class="flex screen-height w-max items-center space-x-[18px] px-[calc(50vw-163px)] sm:hidden">
    {#each reelUrls as reelUrl (reelUrl)}
