...
2. Install the following to your project:
    - [sphinx](https://www.sphinx-doc.org/en/master/): `poetry add sphinx --group dev`
    - [sphinx-autoapi](https://sphinx-autoapi.readthedocs.io/en/stable/): `poetry add sphinx-autoapi --group dev`
    - [myst-parser](https://myst-parser.readthedocs.io): `poetry add myst-parser --group dev`
